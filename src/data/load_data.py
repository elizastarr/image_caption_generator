...
def load_predictions():
    return pickle.load(
        open(os.path.join(data_folder, "predictions_word_test.pkl"), "rb")
    )
...
if __name__ == "__main__":
    ...
    print(
        "Train representations {}, captions {}, images {}".format(
            image_representations_train.shape, captions_train.shape, images_train.shape
        )
    )
    print(
        "Validation representations {}, captions {}, images {}".format(
            image_representations_val.shape, captions_val.shape, images_val.shape
        )
    )
    print(
        "Test representations {}, captions {}, images {}".format(
            image_representations_test.shape, captions_test.shape, images_test.shape
        )
    )
