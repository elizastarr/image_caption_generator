...
def load_train():
    image_codes_train = pickle.load(
        open(os.path.join(data_folder, "image_codes_train.pkl"), 'rb'))
    ...
    return image_codes_train, captions_train, images_train

def load_val():
    image_codes_val = pickle.load(
        open(os.path.join(data_folder, "image_codes_val.pkl"), 'rb'))
    ...
    return image_codes_val, captions_val, images_val

def load_test():
    image_codes_test = pickle.load(
        open(os.path.join(data_folder, "image_codes_test.pkl"), 'rb'))
    ...
    return image_codes_test, captions_test, images_test
...
if __name__ == "__main__":
    image_codes_train, captions_train, images_train = load_train()
    image_codes_val, captions_val, images_val = load_val()
    image_codes_test, captions_test, images_test = load_test()
    print("Train representations {}, captions {}, images {}".format(image_codes_train.shape, captions_train.shape, images_train.shape))
    print("Validation representations {}, captions {}, images {}".format(image_codes_val.shape, captions_val.shape, images_val.shape))
    print("Test representations {}, captions {}, images {}".format(image_codes_test.shape, captions_test.shape, images_test.shape))
